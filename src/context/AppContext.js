...
const initialState = {
  budget: 2000,
  expenses: [
    { id: uuidv4(), name: "Shopping", cost: 50, category: categories.green },
    { id: uuidv4(), name: "Holiday", cost: 300, category: categories.red },
    {
      id: uuidv4(),
      name: "Transportation",
      cost: 70,
    ...
    { id: uuidv4(), name: "Fuel", cost: 40, category: categories.brown },
    {
      id: uuidv4(),
      name: "Child Care",
      cost: 500,
